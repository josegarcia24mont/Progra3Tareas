...
public class CampeonatoFutbol extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SimularGanador = new javax.swing.JButton();
        ...
        SimularGanador.setText("Simular ganador ");
        SimularGanador.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SimularGanadorActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(SimularGanador, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void SimularGanadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimularGanadorActionPerformed
      double[] probabilidades = new double[equipos.length];
    int indiceEquipo = -1;
    double maxProbabilidad = -1;
    ...
    for (int i = 0; i < equipos.length; i++) {
        ...
        if (partidosJugados != 0) {
            probabilidades[i] = (double) partidosGanados / partidosJugados;
            if (probabilidades[i] > maxProbabilidad) {
                maxProbabilidad = probabilidades[i];
                indiceEquipo = i;
            }
        }
    }

    String equipoMasProbable;
    if (indiceEquipo != -1) {
        equipoMasProbable = equipos[indiceEquipo];
    } else {
        System.err.println("No se puede determinar un equipo con más posibilidades.");
        equipoMasProbable = "No se puede determinar un equipo con más posibilidades.";
    }
    
    System.out.println("El equipo con más posibilidades es: " + equipoMasProbable);
    }//GEN-LAST:event_SimularGanadorActionPerformed
    ...
    private javax.swing.JButton SimularGanador;
